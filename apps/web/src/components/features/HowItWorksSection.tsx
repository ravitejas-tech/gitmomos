...
const STEPS = [
  { step: '01', title: 'Install CLI', desc: 'Run npm install -g gitmomos to get the tool locally.' },
  { step: '02', title: 'Login via CLI', desc: 'Run gitmomos login to authenticate and link your account.' },
  { step: '03', title: 'Track commits', desc: 'Add projects with gitmomos project add and commit naturally.' },
  { step: '04', title: 'View reports', desc: 'Run gitmomos report today or sync to see your dashboard.' },
];
